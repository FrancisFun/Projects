...
public class Constant {
     ...
     * 查询是否已注册URL
     */
    public static final String IS_REGISTERED_URL="http://<HOST AND PORT>/user/isRegistered";

    /**
     * 注册URL
     */
    public static final String REGISTER_URL="http://<HOST AND PORT>/user/registry";

    /**
     * 登陆URL
     */
    public static final String LOGIN_URL = "http://<HOST AND PORT>/auth/login";

    /**
     * 查询用户信息URL
     */
    public static final String QUERY_USER_URL = "http://<HOST AND PORT>/driver/getByName?userName=";

    /**
     * 评价乘客URL
     */
    public static final String RATE_FOR_PASSENGER_URL ="http://<HOST AND PORT>/driver/rateForPassenger?orderId=";

    /**
     * WebSocket地址
     */
    public static final String WEB_SOCKET_URI = "ws://<HOST AND PORT>/webSocket?accessToken=";
     ...
     *传送统计数据URL
     */
    public static final String POST_DRIVER_STATISTICS_URL = "http://<HOST AND PORT>/driver/setStatistics";
}
